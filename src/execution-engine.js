...
export function createExecutionEngine({ root, childAdapter, gitAdapter, integrate, test, generation = 1 } = {}) {
  ...
  return {
    async run(plan, { baseRevision, prompt = 'Execute the approved unit plan', approvedDigest = null, activeGeneration = generation } = {}) {
